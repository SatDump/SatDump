...
namespace fec
{
    namespace code
    {
        cc_encoder_impl::cc_encoder_impl(int frame_size, int k, int rate, std::vector<int> polys, int start_state, cc_mode_t mode, bool padded)
            : d_rate(rate),
              d_k(k),
              d_polys(polys),
        ...
        int cc_encoder_impl::get_output_size()
        {
            return d_output_size;
        }

        int cc_encoder_impl::get_input_size()
        {
            return d_frame_size;
        }
        ...
        int cc_encoder_impl::parityb(unsigned char x)
        {
            return Partab[x];
        }
