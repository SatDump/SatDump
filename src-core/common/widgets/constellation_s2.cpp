        ...
        void ConstellationViewerDVBS2::draw()
        {
            ...
            for (int i = 0; i < CONST_SIZE / 4; i++)
            {
                draw_list->AddCircleFilled(
                    ImVec2(ImGui::GetCursorScreenPos().x + ((d_constellation_size / 2) * ui_scale + sample_buffer_complex_float_plheader[i].real * (d_constellation_size / 2) * d_hscale * ui_scale),
                    ...
                    2 * ui_scale * (d_constellation_size / 200.0f), style::theme.red);
            }
            ...
            {
                draw_list->AddCircleFilled(
                    ImVec2(ImGui::GetCursorScreenPos().x + ((d_constellation_size / 2) * ui_scale + sample_buffer_complex_float_slots[i].real * (d_constellation_size / 2) * d_hscale * ui_scale),
                    ...
                    2 * ui_scale * (d_constellation_size / 200.0f), style::theme.constellation);
            }
            ...
            if (has_pilots)
            {
                ...
                {
                    draw_list->AddCircleFilled(
                        ImVec2(ImGui::GetCursorScreenPos().x + ((d_constellation_size / 2) * ui_scale + sample_buffer_complex_float_pilots[i].real * (d_constellation_size / 2) * d_hscale * ui_scale),
