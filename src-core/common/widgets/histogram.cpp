...
namespace widgets
{
    ...
    void HistoViewer::draw()
    {
        ...
        ImPlot::BeginPlot("##Histogram", ImVec2(200, 200), ImPlotFlags_NoTitle | ImPlotFlags_NoFrame | ImPlotFlags_NoMouseText | ImPlotFlags_NoLegend | ImPlotFlags_NoBoxSelect);
