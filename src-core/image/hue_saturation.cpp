...
namespace satdump
{
    namespace image
    {
        ...
        {
            double v = config.hue[primary_range] * primary_intensity + config.hue[secondary_range] * secondary_intensity;
        ...
        double map_saturation(HueSaturation config, HueRange range, double value)
        {
