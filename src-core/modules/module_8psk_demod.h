...
class PSK8DemodModule : public ProcessingModule
{
protected:
...
public:
    PSK8DemodModule(std::string input_file, std::string output_file_hint, std::map<std::string, std::string> parameters);
    ~PSK8DemodModule();
    void init();
    void stop();
    void process();
