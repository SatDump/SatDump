...
namespace fengyun
{
    ...
    //*****************************************************************************
    void FengyunMPTViterbi::do_reset()
    {
    ...
    //    ENTER idle state
    //*****************************************************************************
    void FengyunMPTViterbi::enter_idle()
    {
        d_state = ST_IDLE;
        d_valid_packet_count = 0;
        d_shift = 0;
    ...
    //    ENTER synced state
    //*****************************************************************************
    void FengyunMPTViterbi::enter_synced()
    {
        d_state = ST_SYNCED;
        d_invalid_packet_count = 0;
    ...
    //*****************************************************************************
    float FengyunMPTViterbi::ber_calc1(
    ...
    //
    //*****************************************************************************
    int FengyunMPTViterbi::work(std::complex<float> *in_syms, size_t size, uint8_t *output)
    {
    ...
    unsigned char &FengyunMPTViterbi::getState()
    {
        return d_state;
    }
