...
namespace goes
{
    namespace hrit
    {
        HRITViterbi::HRITViterbi(float ber_threshold, int outsync_after, int buffer_size) : d_buffer_size(buffer_size),
        ...
        float HRITViterbi::getBER(uint8_t *input)
        {
        ...
        int HRITViterbi::work(uint8_t *input, size_t size, uint8_t *output)
        {
            int data_size_out = 0;
