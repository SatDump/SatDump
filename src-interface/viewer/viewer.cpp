...
namespace satdump
{
        ...
        : Application("viewer")
    {
        ...
        // loadProductsInViewer("/home/alan/Documents/SatDump_ReWork/build/metop_ahrpt_new/SEM/product.cbor", "MetOp-B AHRPT");
    }
    ...
    void ViewerApplication::drawUI()
    {
        ...
        ImGui::BeginGroup();
        products_and_handlers[current_handler_id].handler->drawContents({viewer_size.x * 0.80 - 4, viewer_size.y});
        ImGui::EndGroup();
    }
