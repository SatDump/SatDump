        ...
        void PROBAInstrumentsDecoderModule::drawUI(bool window)
        {
            ...
            if (ImGui::BeginTable("##probainstrumentstable", 3, ImGuiTableFlags_Borders | ImGuiTableFlags_RowBg))
            {
                ...
                if (d_satellite == PROBA_1)
                {
                    ...
                    ImGui::Text("CHRIS");
                    ImGui::TableSetColumnIndex(1);
                    ImGui::TextColored(IMCOLOR_GREEN, "%d", chris_reader->cnt());
                    ImGui::TableSetColumnIndex(2);
                    ...
                    ImGui::Text("HRC");
                    ImGui::TableSetColumnIndex(1);
                    ImGui::TextColored(IMCOLOR_GREEN, "%d", hrc_reader->getCount());
                    ImGui::TableSetColumnIndex(2);
                ...
                if (d_satellite == PROBA_2)
                {
                    ...
                    ImGui::Text("SWAP");
                    ImGui::TableSetColumnIndex(1);
                    ImGui::TextColored(IMCOLOR_GREEN, "%d", swap_reader->count);
                    ImGui::TableSetColumnIndex(2);
                ...
                if (d_satellite == PROBA_V)
                {
                    for (int i = 0; i < 3; i++)
                    {
                        ...
                        ImGui::TableSetColumnIndex(1);
                        ImGui::TextColored(IMCOLOR_GREEN, "%d", vegs_readers[i][0]->lines);
                        ImGui::TableSetColumnIndex(2);
                        ...
                        ImGui::TableSetColumnIndex(1);
                        ImGui::TextColored(IMCOLOR_GREEN, "%d", vegs_readers[i][1]->lines);
                        ImGui::TableSetColumnIndex(2);
                        ...
                        ImGui::Text("Vegetation %d Ch2", i + 1);
                        ImGui::TableSetColumnIndex(1);
                        ImGui::TextColored(IMCOLOR_GREEN, "%d", vegs_readers[i][2]->lines);
                        ImGui::TableSetColumnIndex(2);
                        ...
                        ImGui::TableSetColumnIndex(1);
                        ImGui::TextColored(IMCOLOR_GREEN, "%d", vegs_readers[i][3]->lines);
                        ImGui::TableSetColumnIndex(2);
                        ...
                        ImGui::TableSetColumnIndex(1);
                        ImGui::TextColored(IMCOLOR_GREEN, "%d", vegs_readers[i][4]->lines);
                        ImGui::TableSetColumnIndex(2);
                        ...
                        ImGui::TableSetColumnIndex(1);
                        ImGui::TextColored(IMCOLOR_GREEN, "%d", vegs_readers[i][5]->lines);
                        ImGui::TableSetColumnIndex(2);
