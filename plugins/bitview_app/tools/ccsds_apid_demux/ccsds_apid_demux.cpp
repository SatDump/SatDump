...
namespace satdump
{
    std::string CCSDSAPIDDemuxTool::getName() { return "CCSDS APID Demux"; }

    void CCSDSAPIDDemuxTool::renderMenu(std::shared_ptr<BitContainer> &container, bool is_busy)
    {
        if (is_busy)
            style::beginDisabled();
    ...
    bool CCSDSAPIDDemuxTool::needToProcess() { return should_process; }
