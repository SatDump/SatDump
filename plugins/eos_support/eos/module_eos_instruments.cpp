        ...
        void EOSInstrumentsDecoderModule::drawUI(bool window)
        {
            ...
            if (ImGui::BeginTable("##eosinstrumentstable", 3, ImGuiTableFlags_Borders | ImGuiTableFlags_RowBg))
            {
                ...
                if (d_satellite == TERRA || d_satellite == AQUA)
                {
                    ...
                    ImGui::Text("MODIS");
                    ImGui::TableSetColumnIndex(1);
                    ImGui::TextColored(IMCOLOR_GREEN, "%d", modis_reader.lines);
                    ImGui::TableSetColumnIndex(2);
                ...
                if (d_satellite == AQUA)
                {
                    ...
                    ImGui::Text("AIRS");
                    ImGui::TableSetColumnIndex(1);
                    ImGui::TextColored(IMCOLOR_GREEN, "%d", airs_reader.lines);
                    ImGui::TableSetColumnIndex(2);
                    ...
                    ImGui::Text("AMSU A1");
                    ImGui::TableSetColumnIndex(1);
                    ImGui::TextColored(IMCOLOR_GREEN, "%d", amsu_a1_reader.lines);
                    ImGui::TableSetColumnIndex(2);
                    ...
                    ImGui::Text("AMSU A2");
                    ImGui::TableSetColumnIndex(1);
                    ImGui::TextColored(IMCOLOR_GREEN, "%d", amsu_a2_reader.lines);
                    ImGui::TableSetColumnIndex(2);
                    drawStatus(amsu_status);
                    ...
                    ImGui::TableSetColumnIndex(1);
                    ImGui::TextColored(IMCOLOR_GREEN, "%d", ceres_fm3_reader.lines);
                    ImGui::TableSetColumnIndex(2);
                    ...
                    ImGui::TableSetColumnIndex(1);
                    ImGui::TextColored(IMCOLOR_GREEN, "%d", ceres_fm4_reader.lines);
                    ImGui::TableSetColumnIndex(2);
                ...
                if (d_satellite == AURA)
                {
                    ...
                    ImGui::Text("OMI 1");
                    ImGui::TableSetColumnIndex(1);
                    ImGui::TextColored(IMCOLOR_GREEN, "%d", omi_1_reader.lines);
                    ImGui::TableSetColumnIndex(2);
                    ...
                    ImGui::Text("OMI 2");
                    ImGui::TableSetColumnIndex(1);
                    ImGui::TextColored(IMCOLOR_GREEN, "%d", omi_2_reader.lines);
                    ImGui::TableSetColumnIndex(2);
                    drawStatus(omi_status);
                }
