...
namespace jpss
{
    ...
    {
        class JPSSInstrumentsDecoderModule : public satdump::pipeline::base::FileStreamToFileStreamModule
        {
        protected:
            const bool npp_mode;
            ...
            viirs::VIIRSReader viirs_reader_imaging[5] = {viirs::VIIRSChannels[818], viirs::VIIRSChannels[819], viirs::VIIRSChannels[820], viirs::VIIRSChannels[813], viirs::VIIRSChannels[817]};
            viirs::VIIRSReader viirs_reader_dnb[3] = {viirs::VIIRSChannels[821], viirs::VIIRSChannels[822], viirs::VIIRSChannels[823]};
            ...
            instrument_status_t viirs_moderate_status[16] = {DECODING, DECODING, DECODING, DECODING, DECODING, DECODING, DECODING, DECODING,
                                                             DECODING, DECODING, DECODING, DECODING, DECODING, DECODING, DECODING, DECODING};
