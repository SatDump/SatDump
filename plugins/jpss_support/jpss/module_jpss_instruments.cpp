    ...
    namespace instruments
    {
        ...
        void JPSSInstrumentsDecoderModule::drawUI(bool window)
        {
            ...
            if (ImGui::BeginTable("##jpssinstrumentstable", 3, ImGuiTableFlags_Borders | ImGuiTableFlags_RowBg))
            {
                ...
                ImGui::Text("ATMS");
                ImGui::TableSetColumnIndex(1);
                ImGui::TextColored(IMCOLOR_GREEN, "%d", atms_reader.lines);
                ImGui::TableSetColumnIndex(2);
                ...
                ImGui::TableSetColumnIndex(1);
                ImGui::TextColored(IMCOLOR_GREEN, "%d", omps_nadir_reader.lines);
                ImGui::TableSetColumnIndex(2);
                ...
                ImGui::TableSetColumnIndex(1);
                ImGui::TextColored(IMCOLOR_GREEN, "%d", omps_limb_reader.lines);
                ImGui::TableSetColumnIndex(2);
                ...
                for (int i = 0; i < 16; i++)
                {
                    ...
                    ImGui::TableSetColumnIndex(1);
                    ImGui::TextColored(IMCOLOR_GREEN, "%d", (int)viirs_reader_moderate[i].segments.size());
                    ImGui::TableSetColumnIndex(2);
                ...
                for (int i = 0; i < 5; i++)
                {
                    ...
                    ImGui::TableSetColumnIndex(1);
                    ImGui::TextColored(IMCOLOR_GREEN, "%d", (int)viirs_reader_imaging[i].segments.size());
                    ImGui::TableSetColumnIndex(2);
                ...
                ImGui::TableSetColumnIndex(1);
                ImGui::TextColored(IMCOLOR_GREEN, "%d", (int)viirs_reader_dnb[0].segments.size());
                ImGui::TableSetColumnIndex(2);
