    ...
    namespace iasi
    {
        ...
        public:
            ...
            double compute(int channel, int pos_x, int pos_y, int px_val)
            {
                ...
                double space_radiance = temperature_to_radiance(2.73, freq_to_wavenumber(freq));
                double warm_radiance = temperature_to_radiance(bbt_temp, freq_to_wavenumber(freq));
