    ...
    namespace instruments
    {
        ...
        void MetOpInstrumentsDecoderModule::drawUI(bool window)
        {
            ...
            if (ImGui::BeginTable("##metopinstrumentstable", 3, ImGuiTableFlags_Borders | ImGuiTableFlags_RowBg))
            {
                ...
                ImGui::Text("IASI");
                ImGui::TableSetColumnIndex(1);
                ImGui::TextColored(IMCOLOR_GREEN, "%d", iasi_reader.lines);
                ImGui::TableSetColumnIndex(2);
                ...
                ImGui::TableSetColumnIndex(1);
                ImGui::TextColored(IMCOLOR_GREEN, "%d", iasi_reader_img.lines * 64);
                ImGui::TableSetColumnIndex(2);
                ...
                ImGui::Text("GOME");
                ImGui::TableSetColumnIndex(1);
                ImGui::TextColored(IMCOLOR_GREEN, "%d", gome_reader.lines);
                ImGui::TableSetColumnIndex(2);
                ...
                ImGui::Text("ASCAT");
                ImGui::TableSetColumnIndex(1);
                ImGui::TextColored(IMCOLOR_GREEN, "%d", ascat_reader.lines[0]);
                ImGui::TableSetColumnIndex(2);
                drawStatus(gome_status);
                ...
                ImGui::Text("SEM");
                ImGui::TableSetColumnIndex(1);
                ImGui::TextColored(IMCOLOR_GREEN, "%d", sem_reader.samples);
                ImGui::TableSetColumnIndex(2);
                ...
                ImGui::TableSetColumnIndex(1);
                ImGui::TextColored(IMCOLOR_GREEN, "%d", admin_msg_reader.count);
                ImGui::TableSetColumnIndex(2);
