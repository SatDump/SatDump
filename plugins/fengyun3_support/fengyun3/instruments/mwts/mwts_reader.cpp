...
namespace fengyun3
{
    namespace mwts
    {
        ...
        image2::Image MWTSReader::getChannel(int channel)
        {
            timestamps.clear();
            ...
            image2::Image img(16, 58, imageVector.size(), 1);
            ...
            if (imageVector.size() > 0)
            {
                ...
                {
                    std::memcpy(img.raw_data() + line * 58 * img.typesize(), lineData.second[channel].data(), 2 * 58);
                    line++;
