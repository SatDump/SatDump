...
namespace orbcomm
{
    ...
    void OrbcommPlotterModule::process()
    {
        ...
        double qth_lon = satdump::satdump_cfg.main_cfg["satdump_general"]["qth_lon"]["value"].get<double>();
        double qth_lat = satdump::satdump_cfg.main_cfg["satdump_general"]["qth_lat"]["value"].get<double>();
        double qth_alt = satdump::satdump_cfg.main_cfg["satdump_general"]["qth_alt"]["value"].get<double>();
