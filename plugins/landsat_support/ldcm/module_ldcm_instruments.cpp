    ...
    namespace instruments
    {
        ...
        void LDCMInstrumentsDecoderModule::drawUI(bool window)
        {
            ...
            if (ImGui::BeginTable("##tirsinstrumentstable", 3, ImGuiTableFlags_Borders | ImGuiTableFlags_RowBg))
            {
                ...
                ImGui::Text("TIRS 1");
                ImGui::TableSetColumnIndex(1);
                ImGui::TextColored(IMCOLOR_GREEN, "%d", tirs_reader1.lines);
                ImGui::TableSetColumnIndex(2);
                ...
                ImGui::Text("TIRS 2");
                ImGui::TableSetColumnIndex(1);
                ImGui::TextColored(IMCOLOR_GREEN, "%d", tirs_reader2.lines);
                ImGui::TableSetColumnIndex(2);
                drawStatus(tirs_status);
                ...
                ImGui::Text("TIRS 3");
                ImGui::TableSetColumnIndex(1);
                ImGui::TextColored(IMCOLOR_GREEN, "%d", tirs_reader3.lines);
                ImGui::TableSetColumnIndex(2);
                drawStatus(tirs_status);
