        ...
        void STDCDecoderModule::drawUI(bool window)
        {
            ...
            ImGui::BeginGroup();
            {
                ImGui::Button("Correlator", {200 * ui_scale, 20 * ui_scale});
                {
                    ...
                    satdump::widgets::ThemedPlotLines(style::theme.plot_bg.Value, "##correlator_plot", cor_history, IM_ARRAYSIZE(cor_history), 0, "", 60.0f, 128.0f, ImVec2(200 * ui_scale, 50 * ui_scale));
                }
                ...
                ImGui::Button("Viterbi", {200 * ui_scale, 20 * ui_scale});
                {
                    ...
                    satdump::widgets::ThemedPlotLines(style::theme.plot_bg.Value, "##viterbi_plot", ber_history, IM_ARRAYSIZE(ber_history), 0, "", 0.0f, 1.0f, ImVec2(200 * ui_scale, 50 * ui_scale));
                }
            }
            ImGui::EndGroup();
