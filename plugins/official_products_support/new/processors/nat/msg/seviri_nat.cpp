    ...
    namespace official
    {
        ...
        void SEVIRINatProcessor::ingestFile(std::vector<uint8_t> file)
        {
            ...
            time_t prod_timestamp = time(0);
            {
                ...
                if (sscanf(mh_strs[17].c_str(), "SSBT                        : %4d%2d%2d%2d%2d%2d.%*dZ", &timeS.tm_year, &timeS.tm_mon, &timeS.tm_mday, &timeS.tm_hour, &timeS.tm_min, &timeS.tm_sec) ==
                    6)
                {
                    timeS.tm_year -= 1900;
                    timeS.tm_mon -= 1;
            ...
            // Saving
            seviri_products = std::make_shared<satdump::products::ImageProduct>();
        ...
        std::shared_ptr<satdump::products::Product> SEVIRINatProcessor::getProduct() { return seviri_products; }
    } // namespace official
} // namespace satdump