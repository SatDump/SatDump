...
namespace nat2pro
{
    class MHSNatCalibrator : public satdump::products::ImageCalibrator
    {

    public:
        MHSNatCalibrator(satdump::products::ImageProduct *p, nlohmann::json c) : satdump::products::ImageCalibrator(p, c)
        {
        }
