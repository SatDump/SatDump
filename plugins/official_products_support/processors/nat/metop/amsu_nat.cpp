...
namespace satdump
{
    namespace official
    {
        void AMSUNatProcessor::ingestFile(std::vector<uint8_t> nat_file)
        {
            int image_width = 30;
...

            {
                ...
                amsu_products = std::make_shared<satdump::products::ImageProduct>();
        ...
        std::shared_ptr<satdump::products::Product> AMSUNatProcessor::getProduct() { return amsu_products; }
    } // namespace official
} // namespace satdump